...
func (f *BooleanField) Exact(value bool) lookup {
	return lookup{lhs: f, lookupName: "=", rhs: boolToSql(value)}
}

func (f *FloatField) Exact(value float64) lookup {
	return lookup{lhs: f, lookupName: "=", rhs: float64ToSql(value)}
}
...
func (f *TextField) Contains(value string) lookup {
	value = "%" + value + "%"
	return lookup{lhs: f, lookupName: "LIKE", rhs: stringToSql(value)}
}
...
func (f *BooleanField) In(values ...bool) lookup {
	return lookup{lhs: f, lookupName: "IN", rhs: boolSliceToSql(values)}
}

func (f *FloatField) In(values ...float64) lookup {
	return lookup{lhs: f, lookupName: "IN", rhs: float64SliceToSql(values)}
}
